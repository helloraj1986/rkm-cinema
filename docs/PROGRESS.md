## ▶ 📋 **APPLE CLIENTS — XCODE ALONE IS ENOUGH; XCODEGEN DEMOTED TO A FALLBACK** (2026-09-13, latest) · branch **`feat/apple-clients`** · docs: **`apple/WORKFLOW.md` §2** (rewritten), **`apple/scripts/mac-round.sh`** (updated) · **no app code, no deploy**
